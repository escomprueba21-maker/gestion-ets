...
SELECT
    cat01.id_carrera,
    cat01.tx_nombre,
    COUNT(examenes_periodo.id_ets) AS total_ets
FROM cat01_carrera cat01
LEFT JOIN esc01_carrera_materia esc01
    ON esc01.fk_id_carrera = cat01.id_carrera
LEFT JOIN examenes_periodo
    ON examenes_periodo.fk_id_materia = esc01.fk_id_materia
